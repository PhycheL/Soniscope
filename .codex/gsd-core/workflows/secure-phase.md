...
```
Agent(
  prompt="Read /Users/bemied/ProjectCode/my_soniscope/.codex/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/bemied/ProjectCode/my_soniscope/.codex/gsd-core/templates/SECURITY.md`
