...
```
Agent(
  prompt="Read /Volumes/Data/ProjectCode/my_soniscope/.codex/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Volumes/Data/ProjectCode/my_soniscope/.codex/gsd-core/templates/SECURITY.md`
