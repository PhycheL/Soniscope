...
- **Global scope**: `/Volumes/Data/ProjectCode/my_soniscope/.codex/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Volumes/Data/ProjectCode/my_soniscope/.codex/notes/`)
...
2. Glob `/Volumes/Data/ProjectCode/my_soniscope/.codex/notes/*.md` (if directory exists) — global notes
...
Global (/Volumes/Data/ProjectCode/my_soniscope/.codex/notes/):
...
2. **No `.planning/`**: Falls back to global `/Volumes/Data/ProjectCode/my_soniscope/.codex/notes/` — works in any directory
