...
Key references:
- @/Volumes/Data/ProjectCode/my_soniscope/.codex/gsd-core/references/ui-brand.md (display patterns)
- @/Volumes/Data/ProjectCode/my_soniscope/.codex/agents/gsd-user-profiler.md (profiler agent definition)
- @/Volumes/Data/ProjectCode/my_soniscope/.codex/gsd-core/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="/Volumes/Data/ProjectCode/my_soniscope/.codex/gsd-core/USER-PROFILE.md"
...
```bash
cp "/Volumes/Data/ProjectCode/my_soniscope/.codex/gsd-core/USER-PROFILE.md" "/Volumes/Data/ProjectCode/my_soniscope/.codex/USER-PROFILE.backup.md"
```
...
✓ Stores profile at /Volumes/Data/ProjectCode/my_soniscope/.codex/gsd-core/USER-PROFILE.md
...
- The user-profiling reference doc at `/Volumes/Data/ProjectCode/my_soniscope/.codex/gsd-core/references/user-profiling.md`
...
Reference: @/Volumes/Data/ProjectCode/my_soniscope/.codex/gsd-core/references/user-profiling.md
...
Display: "✓ Profile written to /Volumes/Data/ProjectCode/my_soniscope/.codex/gsd-core/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global AGENTS.md" -- "Add profile to /Volumes/Data/ProjectCode/my_soniscope/.codex/AGENTS.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at /Volumes/Data/ProjectCode/my_soniscope/.codex/gsd-core/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated $gsd-dev-preferences at /Volumes/Data/ProjectCode/my_soniscope/.codex/skills/gsd-dev-preferences/SKILL.md"
...
Display: "✓ Added profile section to /Volumes/Data/ProjectCode/my_soniscope/.codex/AGENTS.md"
...
```bash
BACKUP_PATH="/Volumes/Data/ProjectCode/my_soniscope/.codex/USER-PROFILE.backup.md"
```
...
Your profile:    /Volumes/Data/ProjectCode/my_soniscope/.codex/gsd-core/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ $gsd-dev-preferences   /Volumes/Data/ProjectCode/my_soniscope/.codex/skills/gsd-dev-preferences/SKILL.md
  ✓ AGENTS.md section       <resolved claude_md_path, default ./.codex/AGENTS.md>
  ✓ Global AGENTS.md        /Volumes/Data/ProjectCode/my_soniscope/.codex/AGENTS.md
```
