...
<required_reading>
@/Volumes/Data/ProjectCode/my_soniscope/.codex/gsd-core/references/ai-frameworks.md
@/Volumes/Data/ProjectCode/my_soniscope/.codex/gsd-core/references/ai-evals.md
</required_reading>
...
```markdown
Read /Volumes/Data/ProjectCode/my_soniscope/.codex/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/Volumes/Data/ProjectCode/my_soniscope/.codex/gsd-core/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /Volumes/Data/ProjectCode/my_soniscope/.codex/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /Volumes/Data/ProjectCode/my_soniscope/.codex/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /Volumes/Data/ProjectCode/my_soniscope/.codex/agents/gsd-eval-planner.md for instructions.
