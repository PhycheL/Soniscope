...
ones). Reference: @/Users/bemied/ProjectCode/my_soniscope/.codex/gsd-core/references/edge-probe.md.
...
# — NOT the consuming project's git root — falling back to git toplevel / /Users/bemied/ProjectCode/my_soniscope/.codex.
...
EDGE_PROBE_JS=$(for _c in \
  ...
  "/Users/bemied/ProjectCode/my_soniscope/.codex/gsd-core/bin/lib/edge-probe.cjs" \
  "/Users/bemied/ProjectCode/my_soniscope/.codex/bin/lib/edge-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
...
requirement list). Reference: @/Users/bemied/ProjectCode/my_soniscope/.codex/gsd-core/references/prohibition-probe.md — the
...
Use the SPEC.md template from @/Users/bemied/ProjectCode/my_soniscope/.codex/gsd-core/templates/spec.md.
