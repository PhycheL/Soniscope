...
<execution_context>
@/Volumes/Data/ProjectCode/my_soniscope/.codex/gsd-core/workflows/pause-work.md
</execution_context>
...
Read and execute `/Volumes/Data/ProjectCode/my_soniscope/.codex/gsd-core/workflows/session-report.md` end-to-end.
