...
- @/Volumes/Data/ProjectCode/my_soniscope/.codex/gsd-core/workflows/complete-milestone.md (main workflow)
- @/Volumes/Data/ProjectCode/my_soniscope/.codex/gsd-core/templates/milestone-archive.md (archive template)
  </execution_context>
