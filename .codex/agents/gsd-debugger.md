...
<required_reading>
@/Volumes/Data/ProjectCode/my_soniscope/.codex/gsd-core/references/common-bug-patterns.md
</required_reading>
...
@/Volumes/Data/ProjectCode/my_soniscope/.codex/gsd-core/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /Volumes/Data/ProjectCode/my_soniscope/.codex
                  → checks /Volumes/Data/ProjectCode/my_soniscope/.codex/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /Volumes/Data/ProjectCode/my_soniscope/.codex/gsd-core
                  → writes to /Volumes/Data/ProjectCode/my_soniscope/.codex/gsd-core/hooks/
...
@/Volumes/Data/ProjectCode/my_soniscope/.codex/gsd-core/references/thinking-models-debug.md
...
- Read @/Volumes/Data/ProjectCode/my_soniscope/.codex/gsd-core/references/common-bug-patterns.md
