...
**Verification depth scales with `asvs_level`** (see @/Users/bemied/ProjectCode/my_soniscope/.codex/gsd-core/references/security-asvs-levels.md for full definitions):
