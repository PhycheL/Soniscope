...
Reference full template: `/Volumes/Data/ProjectCode/my_soniscope/.codex/gsd-core/templates/roadmap.md`

## STATE.md Structure

Use template from `/Volumes/Data/ProjectCode/my_soniscope/.codex/gsd-core/templates/state.md`.
