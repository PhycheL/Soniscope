...
<!-- For checkpoint task examples and patterns, see @/Users/bemied/ProjectCode/my_soniscope/.claude/gsd-core/references/checkpoints.md -->
...
See `/Users/bemied/ProjectCode/my_soniscope/.claude/gsd-core/references/tdd.md` for TDD plan structure.
...
See `/Users/bemied/ProjectCode/my_soniscope/.claude/gsd-core/templates/user-setup.md` for full schema and examples
...
See `/Users/bemied/ProjectCode/my_soniscope/.claude/gsd-core/workflows/verify-phase.md` for verification logic.
