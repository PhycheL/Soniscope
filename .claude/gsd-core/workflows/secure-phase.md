...
```
Agent(
  prompt="Read /Volumes/Data/ProjectCode/my_soniscope/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Volumes/Data/ProjectCode/my_soniscope/.claude/gsd-core/templates/SECURITY.md`
