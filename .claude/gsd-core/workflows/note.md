...
- **Global scope**: `/Users/bemied/ProjectCode/my_soniscope/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/bemied/ProjectCode/my_soniscope/.claude/notes/`)
...
2. Glob `/Users/bemied/ProjectCode/my_soniscope/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/bemied/ProjectCode/my_soniscope/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/bemied/ProjectCode/my_soniscope/.claude/notes/` — works in any directory
