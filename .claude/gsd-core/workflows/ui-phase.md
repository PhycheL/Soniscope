...
```markdown
Read /Volumes/Data/ProjectCode/my_soniscope/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: /Volumes/Data/ProjectCode/my_soniscope/.claude/gsd-core/templates/UI-SPEC.md
</output>
...
```markdown
Read /Volumes/Data/ProjectCode/my_soniscope/.claude/agents/gsd-ui-checker.md for instructions.
