...
<template>
@/Users/bemied/ProjectCode/my_soniscope/.claude/gsd-core/templates/UAT.md
</template>
...
**MVP-mode UAT framing.** When `MVP_MODE=true`, follow the rules in `@/Users/bemied/ProjectCode/my_soniscope/.claude/gsd-core/references/verify-mvp-mode.md`. Briefly:
...
Read and follow `/Users/bemied/ProjectCode/my_soniscope/.claude/gsd-core/workflows/transition.md`.
...
- Follow @/Users/bemied/ProjectCode/my_soniscope/.claude/gsd-core/workflows/diagnose-issues.md
