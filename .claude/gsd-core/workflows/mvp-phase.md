...
<required_reading>
@/Volumes/Data/ProjectCode/my_soniscope/.claude/gsd-core/references/user-story-template.md
@/Volumes/Data/ProjectCode/my_soniscope/.claude/gsd-core/references/spidr-splitting.md
@/Volumes/Data/ProjectCode/my_soniscope/.claude/gsd-core/references/planner-mvp-mode.md
</required_reading>
...
Normalize per `@/Volumes/Data/ProjectCode/my_soniscope/.claude/gsd-core/references/phase-argument-parsing.md` (zero-pad integer phases to two digits).
...
Run three sequential `AskUserQuestion` calls. Each is free-text. After all three, assemble into the canonical sentence per `@/Volumes/Data/ProjectCode/my_soniscope/.claude/gsd-core/references/user-story-template.md`:
...
Run the SPIDR rules from `@/Volumes/Data/ProjectCode/my_soniscope/.claude/gsd-core/references/spidr-splitting.md`. Briefly:
