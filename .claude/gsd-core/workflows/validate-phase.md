...
```
Agent(
  prompt="Read /Users/bemied/ProjectCode/my_soniscope/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/bemied/ProjectCode/my_soniscope/.claude/gsd-core/templates/VALIDATION.md`
