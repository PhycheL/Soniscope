...
See /Volumes/Data/ProjectCode/my_soniscope/.claude/gsd-core/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using /Volumes/Data/ProjectCode/my_soniscope/.claude/gsd-core/templates/discovery.md structure:
...
1. **Scope the discovery** using /Volumes/Data/ProjectCode/my_soniscope/.claude/gsd-core/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from /Volumes/Data/ProjectCode/my_soniscope/.claude/gsd-core/templates/discovery.md
...
Use /Volumes/Data/ProjectCode/my_soniscope/.claude/gsd-core/templates/discovery.md.
