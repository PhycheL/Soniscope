...
INSTALL_JS_GLOBAL="/Users/bemied/ProjectCode/my_soniscope/.claude/gsd-core/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /Users/bemied/ProjectCode/my_soniscope/.claude/gsd-core/bin/install.js --global --<runtime>
```
Then exit.
