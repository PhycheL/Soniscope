...
<required_reading>
@/Volumes/Data/ProjectCode/my_soniscope/.claude/gsd-core/references/common-bug-patterns.md
</required_reading>
...
@/Volumes/Data/ProjectCode/my_soniscope/.claude/gsd-core/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /Volumes/Data/ProjectCode/my_soniscope/.claude
                  → checks /Volumes/Data/ProjectCode/my_soniscope/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /Volumes/Data/ProjectCode/my_soniscope/.claude/gsd-core
                  → writes to /Volumes/Data/ProjectCode/my_soniscope/.claude/gsd-core/hooks/
...
@/Volumes/Data/ProjectCode/my_soniscope/.claude/gsd-core/references/thinking-models-debug.md
...
- Read @/Volumes/Data/ProjectCode/my_soniscope/.claude/gsd-core/references/common-bug-patterns.md
