...
Use template from `/Volumes/Data/ProjectCode/my_soniscope/.claude/gsd-core/templates/UI-SPEC.md`.
...
Read template: `/Volumes/Data/ProjectCode/my_soniscope/.claude/gsd-core/templates/UI-SPEC.md`
