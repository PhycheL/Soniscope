...
**Verification depth scales with `asvs_level`** (see @/Volumes/Data/ProjectCode/my_soniscope/.claude/gsd-core/references/security-asvs-levels.md for full definitions):
