...
Define the expected behavior for `make verify-prep` checks that validate Worker OSS runtime access and STS upload credential boundaries before MVP acceptance.
