...
<!-- For checkpoint task examples and patterns, see @/Volumes/Data/ProjectCode/my_soniscope/.cursor/gsd-core/references/checkpoints.md -->
...
See `/Volumes/Data/ProjectCode/my_soniscope/.cursor/gsd-core/references/tdd.md` for TDD plan structure.
...
See `/Volumes/Data/ProjectCode/my_soniscope/.cursor/gsd-core/templates/user-setup.md` for full schema and examples
...
See `/Volumes/Data/ProjectCode/my_soniscope/.cursor/gsd-core/workflows/verify-phase.md` for verification logic.
