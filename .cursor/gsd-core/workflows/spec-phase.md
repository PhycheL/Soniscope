...
ones). Reference: @/Users/bemied/ProjectCode/my_soniscope/.cursor/gsd-core/references/edge-probe.md.
...
# — NOT the consuming project's git root — falling back to git toplevel / /Users/bemied/ProjectCode/my_soniscope/.cursor.
...
EDGE_PROBE_JS=$(for _c in \
  ...
  "/Users/bemied/ProjectCode/my_soniscope/.cursor/gsd-core/bin/lib/edge-probe.cjs" \
  "/Users/bemied/ProjectCode/my_soniscope/.cursor/bin/lib/edge-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
...
requirement list). Reference: @/Users/bemied/ProjectCode/my_soniscope/.cursor/gsd-core/references/prohibition-probe.md — the
...
Use the SPEC.md template from @/Users/bemied/ProjectCode/my_soniscope/.cursor/gsd-core/templates/spec.md.
