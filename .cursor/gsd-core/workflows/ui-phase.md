...
```markdown
Read /Volumes/Data/ProjectCode/my_soniscope/.cursor/agents/gsd-ui-researcher.md for instructions.
...
Template: /Volumes/Data/ProjectCode/my_soniscope/.cursor/gsd-core/templates/UI-SPEC.md
</output>
...
```markdown
Read /Volumes/Data/ProjectCode/my_soniscope/.cursor/agents/gsd-ui-checker.md for instructions.
