...
INSTALL_JS_GLOBAL="/Volumes/Data/ProjectCode/my_soniscope/.cursor/gsd-core/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /Volumes/Data/ProjectCode/my_soniscope/.cursor/gsd-core/bin/install.js --global --<runtime>
```
Then exit.
