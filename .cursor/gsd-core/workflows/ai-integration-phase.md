...
<required_reading>
@/Users/bemied/ProjectCode/my_soniscope/.cursor/gsd-core/references/ai-frameworks.md
@/Users/bemied/ProjectCode/my_soniscope/.cursor/gsd-core/references/ai-evals.md
</required_reading>
...
```markdown
Read /Users/bemied/ProjectCode/my_soniscope/.cursor/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/Users/bemied/ProjectCode/my_soniscope/.cursor/gsd-core/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /Users/bemied/ProjectCode/my_soniscope/.cursor/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /Users/bemied/ProjectCode/my_soniscope/.cursor/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /Users/bemied/ProjectCode/my_soniscope/.cursor/agents/gsd-eval-planner.md for instructions.
