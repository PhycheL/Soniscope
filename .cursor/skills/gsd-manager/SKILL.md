...
<execution_context>
@/Volumes/Data/ProjectCode/my_soniscope/.cursor/gsd-core/workflows/manager.md
...
Read and execute `/Volumes/Data/ProjectCode/my_soniscope/.cursor/gsd-core/workflows/analyze-dependencies.md` end-to-end.
