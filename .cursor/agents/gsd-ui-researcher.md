...
Use template from `/Volumes/Data/ProjectCode/my_soniscope/.cursor/gsd-core/templates/UI-SPEC.md`.
...
Read template: `/Volumes/Data/ProjectCode/my_soniscope/.cursor/gsd-core/templates/UI-SPEC.md`
