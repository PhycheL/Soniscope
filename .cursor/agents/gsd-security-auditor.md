...
**Verification depth scales with `asvs_level`** (see @/Users/bemied/ProjectCode/my_soniscope/.cursor/gsd-core/references/security-asvs-levels.md for full definitions):
