...
<required_reading>
@/Volumes/Data/ProjectCode/my_soniscope/.cursor/gsd-core/references/common-bug-patterns.md
</required_reading>
...
@/Volumes/Data/ProjectCode/my_soniscope/.cursor/gsd-core/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /Volumes/Data/ProjectCode/my_soniscope/.cursor
                  → checks /Volumes/Data/ProjectCode/my_soniscope/.cursor/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /Volumes/Data/ProjectCode/my_soniscope/.cursor/gsd-core
                  → writes to /Volumes/Data/ProjectCode/my_soniscope/.cursor/gsd-core/hooks/
...
@/Volumes/Data/ProjectCode/my_soniscope/.cursor/gsd-core/references/thinking-models-debug.md
...
- Read @/Volumes/Data/ProjectCode/my_soniscope/.cursor/gsd-core/references/common-bug-patterns.md
