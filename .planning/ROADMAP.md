...
- [x] 02-02-PLAN.md — 组② HTTP 契约、组③ 镜像常量抽取与重复逻辑普查(CONTRACT-01/03)

**Wave 3** *(blocked on Wave 2 completion)*

- [x] 02-03-PLAN.md — 往返校验执行佐证:基线导出 harness + 样本清单销号(CONTRACT-02)
...
- [x] 03-02-PLAN.md — scans/ 五档全部命中三态销号(确认/误报/移交)+ 对账等式

**Wave 3** *(blocked on Wave 2)*

- [x] 03-03-PLAN.md — CODE:apps/worker 核心 14 模块普审+深挖,HYP-10/16/19 回填(AUDIT-01)

**Wave 4** *(blocked on Wave 3)*

- [x] 03-04-PLAN.md — CODE:apps/fc 12 文件 + apps/miniprogram 21 文件普审+深挖,HYP-01/08/09/12/17/20 回填(AUDIT-01)

**Wave 5** *(blocked on Wave 4)*

- [x] 03-05-PLAN.md — TOOL:Worker 包内验证/运维 12 模块普审+深挖,HYP-04/15 回填(AUDIT-02)

**Wave 6** *(blocked on Wave 5)*

- [x] 03-06-PLAN.md — TOOL:scripts/ 三文件 + Makefile 静读审计,HYP-07/18 回填含 test_asr.py 点名线索结论(AUDIT-02)
...
- [x] 04-01-PLAN.md — worktree 基线专区建立与离线门禁实跑观测(D-01/D-02,喂 D-11)
- [x] 04-03-PLAN.md — DOC-CLAIMS.md 骨架 + PRD/tech-spec 深核四态销号(AUDIT-03)
- [x] 04-06-PLAN.md — TEST-AUDIT.md 骨架:D-10 八面清单 + 41 模块台账 + D-09 反向映射清单

**Wave 2** *(blocked on Wave 1)*

- [x] 04-02-PLAN.md — 双语言覆盖率实测归档(D-03/D-04,含 pytest-cov 合法性检查点)+ 专区拆除
- [x] 04-04-PLAN.md — runbook 4 份深核销号 + HYP-14 发布翻转口径核对(HANDOFF DOC ×2 销号)
- [x] 04-07-PLAN.md — 41 测试模块逐面普审 + HYP-23/24 专项 + 反向映射收敛
...
- [x] 04-09-PLAN.md — HYP 余 11 条回填 + 25/25 总对账(D-13/14/15)+ 零 diff 阶段收尾(AUDIT-05)
...
- [x] 05-02-PLAN.md — REPORT.md 主报告机械组装:方法声明/执行摘要/判定准则/40 行汇总表/工作包/DNF/优点/置信声明(RPT-01~07/09)
